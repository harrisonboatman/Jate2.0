...
//                 <Parallax className='h-[80vh]' bgImage={image3} strength={600}>
//                     <div style={{ height: '150px' }}></div>

//                     </Parallax>

//                     <Parallax className='h-[80vh] mt-[5rem]' bgImage={image2} strength={600}>
//                     <div style={{ height: '150px' }}></div>

//                     </Parallax>

//                     <Parallax className='h-[80vh] mt-[10rem]' bgImage={image4} strength={600}>
//                     <div style={{ height: '150px' }}></div>

//                     </Parallax>
//                     </div>

//                 <div ref={divRef} className='gallery-row'>
